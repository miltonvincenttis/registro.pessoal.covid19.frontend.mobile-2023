...
class InscricaoScreen extends StatelessWidget {
  ...
  Widget _emailField(BuildContext context) {
    return Consumer<InscricaoModel>(builder: (context, model, child) {
      return TextField(
      ...
      child: ElevatedButton(
        onPressed: () {
          ...
          if (inscricaoModel.isValido && inscricaoModel.isSenhasIguais()) {
            ...
            print(
                "inscricaoModel.isSenhasIguais(): ${inscricaoModel.isSenhasIguais()}");
            ...
            if (inscricaoModel.isEmailVazio()) {
              print(
                  "inscricaoModel.isEmailVazio(): ${inscricaoModel.isEmailVazio()}");
              inscricaoModel.defineMensagemErroEmailVazio();
            }

            if (inscricaoModel.isSenha1Vazio()) {
              print(
                  "inscricaoModel.isSenha1Vazio(): ${inscricaoModel.isSenha1Vazio()}");
              inscricaoModel.defineMensagemErroSenha1Vazio();
            }

            if (inscricaoModel.isSenha2Vazio()) {
              print(
                  "inscricaoModel.isSenha2Vazio(): ${inscricaoModel.isSenha2Vazio()}");
        ...
        //--- TODO: color: Color(BUTTON_COLOR),
        //--- TODO: shape: globalDefineButtonShape(),
      ),
    );
  }
