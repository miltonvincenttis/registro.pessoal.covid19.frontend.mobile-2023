...
class EntrarScreen extends StatelessWidget {
  ...
  Widget _emailField(BuildContext context) {
    return Consumer<EntrarModel>(builder: (context, model, child) {
      return TextField(
        ...
        onPressed: () {
          ...
          if (entrarModel.isValido) {
            ...
            if (entrarModel.isEmailVazio()) {
              print(
                  "entrarModel.isEmailVazio(): ${entrarModel.isEmailVazio()}");
              entrarModel.defineMensagemErroEmailVazio();
            }
            if (entrarModel.isSenhaVazio()) {
              print(
                  "entrarModel.isSenhaVazio(): ${entrarModel.isSenhaVazio()}");
