...
class ApiClient {
  void main() {
    Future<http.Response> futureRes = postEntrar(
        "http://localhost:8080/registro-pessoal-covid19",
        EmailPassword(email: 'milton.vincenttis@gmail.com', password: '1234'));
  ...
  ///
  Future<http.Response> postEntrar(
      String service, EmailPassword credenciais) async {
    return http.post(
      service as Uri,
